...
public partial class GanttWindow : Window
{
    ...
    public GanttWindow()
    {
        ...
        GantLenght = 50;
       // dateTimePicker.SelectedDate = Tasks.Min(t => t.ScheduledDate);
    ...
    private void CreateData(DateTime minDate, DateTime maxDate)
    {
       ...
       // var rowgroup1 = GanttControl.CreateGanttRowGroup("Tasks");
        ...
        //{
        //    var rowI = GanttControl.CreateGanttRow(rowgroup1, task.Alias!);

        //    GanttControl.AddGanttTask(rowI,
        //        new GanttTask()
        //        {
    ...
    {
        var minDate = dateTimePicker.SelectedDate;
        if (minDate is not null) 
        {
            DateTime maxDate = minDate.Value.AddDays(GantLenght);
            GanttControl.ClearGantt();
            CreateData(minDate.Value, maxDate);
        }
    }
}
